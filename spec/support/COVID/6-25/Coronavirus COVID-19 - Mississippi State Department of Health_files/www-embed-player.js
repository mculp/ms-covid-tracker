...
function bb(a,b){var c=Xa(a,b);0<=c&&Array.prototype.splice.call(a,c,1)}
...
for(var e=2;e<c.length;e++){var f=c[e];!Ka(f)||Ma(f)&&0<f.nodeType?d(f):G(Jc(f)?cb(f):f,d)}}
...
return a}
var Oc={hb:"allow-forms",ib:"allow-modals",jb:"allow-orientation-lock",kb:"allow-pointer-lock",lb:"allow-popups",mb:"allow-popups-to-escape-sandbox",nb:"allow-presentation",ob:"allow-same-origin",pb:"allow-scripts",qb:"allow-top-navigation",rb:"allow-top-navigation-by-user-activation"},Qc=eb(function(){return Pc()});
...
function cd(a){-1==a.f&&(a.f=$a(a.g,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.f}
...
function xd(a,b){if(a.classList)var c=a.classList.contains(b);else c=a.classList?a.classList:vd(a).match(/\S+/g)||[],c=0<=Xa(c,b);return c}
function yd(){var a=document.body;a.classList?a.classList.remove("inverted-hdpi"):xd(a,"inverted-hdpi")&&wd(a,Ya(a.classList?a.classList:vd(a).match(/\S+/g)||[],function(b){return"inverted-hdpi"!=b}).join(" "))}
...
function Dd(a){if(Ka(a))return cb(a);a=Bd(a);var b=[];Cd(a,function(c){b.push(c)});
return b}
...
function he(a,b,c,d){if(b=a.h[b]){var e=a.f;(b=ab(b,function(f){return e[f+1]==c&&e[f+2]==d}))&&a.P(b)}}
n.P=function(a){var b=this.f[a];if(b){var c=this.h[b];0!=this.j?(this.i.push(a),this.f[a+1]=Ha):(c&&bb(c,a),delete this.f[a],delete this.f[a+1],delete this.f[a+2])}return!!b};
...
;function Je(a){a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),g=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?Array.isArray(b[f])?db(b[f],g):b[f]=[b[f],g]:b[f]=g}catch(k){if("q"!=e[0]){var h=Error("Error decoding URL component");h.params={key:e[0],value:e[1]};T(h)}}}return b}
...
return Ne(a,f||{},!1)}
function bf(a,b){var c=S("CORS_HEADER_WHITELIST")||{},d=J(K(3,a));return d?(c=c[d])?0<=Xa(c,b):!1:!0}
...
var zf=eb(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
...
z("yt_logging_screen.setCurrentScreen",oi,void 0);function pi(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=S("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=S("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=J(K(3,window.location.href));g&&f.push(g);g=J(K(3,d));if(0<=Xa(f,g)||!g&&0==d.lastIndexOf("/",0))if(U("autoescape_tempdata_url")&&(f=document.createElement("a"),Xb(f,d),d=f.href),d){g=d.match(ac);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
...
cb(k.args))}catch(q){throw q.message="yt.pubsub2.Data.deserialize(): "+q.message,q;}}catch(q){throw q.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+q.message,q;}a.call(window,f)}catch(q){T(q)}},vi[b.toString()]?A("yt.scheduler.instance")?Hf(g):V(g,0):g())});
...
v(Di,qi);var zi=new ri("screen-created",Di),Ei=[],Fi=0;function Gi(a,b,c){var d=U("use_default_events_client")?void 0:qh;b={csn:a,parentVe:b.getAsJson(),childVes:Za(c,function(f){return f.getAsJson()})};
...
n.ba=function(a,b){var c=this,d=Ti(this,b);if(d){if(!(0<=Xa(this.Aa,a)||this.j[a])){var e=cj(this,a);this.G&&this.G(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.u&&V(function(){d(c.api)},0)}};
